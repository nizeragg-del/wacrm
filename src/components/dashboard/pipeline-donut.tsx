      ...
      <div className="flex flex-1 flex-col p-5">
        {loading || !data ? (
          ...
          <EmptyState
            ...
            hint="Crie negócios nos Funis para ver a divisão por estágio aqui."
          />
        ) : (
          <>
...
function Donut({ data, currency }: { data: PipelineDonutData; currency: string }) {
  ...
  return (
    <div className="flex items-center justify-center">
      <svg viewBox={`0 0 ${size} ${size}`} className="h-48 w-48" role="img"       aria-label="Valor do funil por estágio">
        {/* background ring */}
