    ...
    <TooltipProvider>
      <div className="grid grid-cols-2 gap-3 rounded-xl border border-slate-800 bg-slate-900/60 p-4 sm:grid-cols-3 xl:grid-cols-6">
        <Metric
          ...
          tooltip="Contagem de todos os negócios neste funil que não estão marcados como Perdido. Negócios ganhos ainda são incluídos."
        />
        <Metric
          icon={<DollarSign className="h-4 w-4 text-primary" />}
          label="Valor do Funil"
          value={formatCurrency(stats.totalValue, defaultCurrency)}
          tooltip="Soma dos valores de todos os negócios neste funil, excluindo negócios marcados como Perdido."
        />
        <Metric
        ...
        <Metric
          ...
          tooltip="Receita esperada: valor de cada negócio aberto × sua probabilidade no estágio. Primeiro estágio ≈ 10%, progressão até 90%, Ganho = 100%. Negócios perdidos são excluídos."
        />
        <Metric
