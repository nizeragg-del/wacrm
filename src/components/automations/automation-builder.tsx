...
const STEP_META: Record<AutomationStepType, StepMeta> = {
  ...
  condition: { label: "Condição (Se/Então)", icon: GitBranch, border: "border-l-amber-500" },
...
const TRIGGER_OPTIONS: { value: AutomationTriggerType; label: string; hint: string }[] = [
  { value: "new_message_received", label: "Nova Mensagem Recebida", hint: "Qualquer mensagem recebida" },
  {
    ...
    hint: "Primeira vez que este contato envia uma mensagem para você (funciona também para contatos adicionados manualmente)",
  },
    ...
    <div className="space-y-2">
      <div>
        ...
        <Input
          ...
          placeholder="ex.: preços, solicitação de demonstração, falar com vendas"
          className="bg-slate-800 text-white"
        />
      </div>
      <div>
